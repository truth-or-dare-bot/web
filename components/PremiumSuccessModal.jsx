				...
				<div className="mx-4">
					<div className="bg-white p-6 text-black rounded-lg mx-auto max-w-2xl relative">
						...
						<div>
							...
							<p className="mt-1">
								Thank you so much for your donation. You now have{" "}
								<b>{transaction?.premiumSlots}</b> total premium slot(s)!
							</p>
							<p className="mt-1">
								A recept has been emailed to you. If you need purchase support,
								feel free to reach out in our{" "}
								<a
									href="/support"
									target="_blank"
							...
							<p>
								Run &quot;/premium activate&quot; in a server of your choice! Do
