	...
	const TODMessage = (
		<DiscordMessages className="rounded-lg" lightTheme={resolvedTheme === "light"}>
			<DiscordMessage author="Truth or Dare" avatar="/icon-192x192.png" bot verified>
				<DiscordCommand slot="reply" author="Sam" avatar="/sam.png" command="/truth"></DiscordCommand>
				<DiscordEmbed slot="embeds" color="#3B82F6" embedTitle="Who's the smelliest here?">
			...
			<DiscordMessage author="Truth or Dare" avatar="/icon-192x192.png" bot verified>
				<DiscordCommand
					...
					author="Sam"
					avatar="/sam.png"
					command="/serversettings disablequestion"></DiscordCommand>
