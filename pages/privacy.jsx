			...
			<div className="flex flex-col mt-24 pb-8 md:pb-32">
				<div className="max-w-5xl mx-auto w-full md:mt-12 px-4">
					...
					<div className="mt-4 text-lg">
						...
						<h1 className="text-2xl font-semibold mt-4">Types of Data Collected</h1>
						...
						<h1 className="text-2xl font-semibold mt-4">Requesting Data Deletion</h1>
						<p className="mt-1">
						...
						<h1 className="text-2xl font-semibold mt-4">Requesting Your Data</h1>
						<p className="mt-1">
