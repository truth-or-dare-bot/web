	...
	return (
		<div>
			...
			<div className="flex flex-col mt-24">
					...
					<div className="md:px-24 container px-6 mx-auto mb-20">
						<div className="lg:grid-cols-2 md:mt-24 grid grid-cols-1 gap-4">
							<div className="flex flex-col">
								<h1 className="md:leading-tight font-extrabold leading-none" style={{ fontSize: "3rem" }}>
								...
								<div className="mt-2">
									...
									<Button href="/support" className="sm:ml-2 sm:mt-0 mt-2" external icon={faUserGroup}>
										Find Other Players
									</Button>
								</div>
							</div>
				...
				<div className="dark:bg-theme-d4 bg-theme-l2 py-6 md:py-12">
					<div className="grid grid-cols-1 md:grid-cols-2 justify-center my-12 md:my-24 text-left max-w-7xl gap-12 px-8 mx-auto">
						<Fade bottom>
							<div className="col-span-1 justify-center my-auto">
								<h2 className="font-bold text-4xl">Get to know your friends!</h2>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 justify-center my-12 md:my-24 text-left max-w-7xl gap-12 px-8 mx-auto">
						<Fade bottom>
							...
							<div className="col-span-1 justify-center my-auto">
								<h2 className="font-bold text-4xl">Multiple games and modes!</h2>
								<p className="text-xl mt-2">
				...
				<Divider type="curveDown" className="dark:fill-theme-d4 dark:bg-theme-d3 fill-theme-l2 bg-theme-l3" />
				{/* Get Started */}
